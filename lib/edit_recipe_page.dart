    ...
    try {
      ...
      if (docSnapshot.exists) {
        ...
        setState(() {
          ...
          final cookingTime =
              data['cookingTime'] ?? ''; // Use 'cookingTime' here
          print('Raw cooking time from Firestore: $cookingTime');

          // Parse cooking time (e.g., "1h 0m 0s")
          final match =
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        Map<String, dynamic> updateData = {
          ...
          'image': updatedImageUrls, // Store the updated image URLs
        };
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    _recipeName, // Use the updated value here
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  "${_hours}h ${_minutes}m ${_seconds}s", // Updated time here
                                  style: const TextStyle(
                                      fontSize: 16, color: Colors.black54),
                                ),
                              ],
                            ...
                            ..._ingredients.split(',').map((ingredient) => Text(
                                  '- ${ingredient.trim()}', // Updated value here
                                  style: const TextStyle(
                                      fontSize: 16, color: Colors.black54),
                                )),
                            const Divider(color: Colors.grey),
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  _difficulty, // Updated value here
                                  style: const TextStyle(
                                      fontSize: 16, color: Colors.black54),
                                ),
                              ],
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            // Set _isLoading to true before updating
                            setState(() {
                              _isLoading = true;
                            });
                ...
                child: Form(
                  ...
                  child: ConstrainedBox(
                    constraints: const BoxConstraints(
                      maxWidth: 600, // Limit the width for better alignment
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          onChanged: (value) {
                            ...
                            _validateIngredients(); // Call real-time validation
                          },
                        ),
                        const SizedBox(height: 15),
