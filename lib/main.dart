...
class _LandingPageState extends State<LandingPage>
  ...
  // Navigate to RecipesPage as Guest with username
  void _navigateToRecipesPage(BuildContext context) {
    // Example username, you can replace this with dynamic data if needed
    String username = "GuestUser"; 

    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => RecipesPage(username: username), // Pass username
      ),
    );
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: ScaleTransition(
                    ...
                    child: GestureDetector(
                      ...
                      child: Image.asset(
                        ...
                        height: 250, // Same height as the original
                        width: 400,  // Same width as the original
                      ),
                    ),
                  ),
                ),
                ...
                // "Continue as Guest" Text with tap functionality
                GestureDetector(
